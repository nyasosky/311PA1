...
public class TestJunit {
    ...
    public void testInsert() {
        // initial
        rt1 = i1.getRBTree();
        assertEquals(rt1.getNILNode(), rt1.getRoot());
    ...
    public void testColor() {
        // initial
        rt1 = i1.getRBTree();
        assertEquals(1, rt1.getRoot().getColor());

        // first insertion
        i1.intervalInsert(0, 4);
        rt1 = i1.getRBTree();
        assertEquals(1, rt1.getRoot().getColor());
        assertEquals(0, rt1.getRoot().getRight().getColor());

        // second insertion
        i1.intervalInsert(1, 6);
        rt1 = i1.getRBTree();
        assertEquals(1, rt1.getRoot().getColor());
        assertEquals(1, rt1.getRoot().getLeft().getColor());
        assertEquals(1, rt1.getRoot().getRight().getColor());
        assertEquals(0, rt1.getRoot().getRight().getRight().getColor());
        ...
        assertEquals(1, rt1.getRoot().getLeft().getColor());
        assertEquals(0, rt1.getRoot().getRight().getColor());
        assertEquals(1, rt1.getRoot().getRight().getRight().getColor());
        assertEquals(1, rt1.getRoot().getRight().getLeft().getColor());
        assertEquals(0, rt1.getRoot().getRight().getRight().getRight().getColor());

        // fourth insertion
        i1.intervalInsert(7, 11);
        rt1 = i1.getRBTree();
        assertEquals(1, rt1.getRoot().getColor());
        assertEquals(0, rt1.getRoot().getLeft().getColor());
        assertEquals(1, rt1.getRoot().getLeft().getLeft().getColor());
        assertEquals(1, rt1.getRoot().getLeft().getRight().getColor());
        assertEquals(0, rt1.getRoot().getRight().getColor());
        assertEquals(1, rt1.getRoot().getRight().getLeft().getColor());
        assertEquals(1, rt1.getRoot().getRight().getRight().getColor());
        assertEquals(0, rt1.getRoot().getRight().getRight().getRight().getColor());
    ...
    public void testEmax() {
        ...
        assertEquals(rt1.getNILNode().getKey(), rt1.getRoot().getRight().getEmax().getValue());
        assertEquals(rt1.getNILNode().getKey(), rt1.getRoot().getRight().getLeft().getEmax().getValue());
        assertEquals(rt1.getNILNode().getKey(), rt1.getRoot().getRight().getRight().getEmax().getValue());
        assertEquals(rt1.getNILNode().getKey(), rt1.getRoot().getRight().getRight().getRight().getEmax().getValue());
